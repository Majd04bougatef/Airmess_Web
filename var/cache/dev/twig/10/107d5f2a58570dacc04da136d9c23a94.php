...
class __TwigTemplate_be4dcc37e1d2720c6002fc04569d7707 extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        ";
        // line 9
        yield Twig\Extension\CoreExtension::include($this->env, $context, "commentaire/_form.html.twig", ["button_label" => "Mettre à jour"]);
        yield "

        <div class=\"mt-3\">
            <a href=\"";
        // line 12
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_social_media_show", ["idEB" => CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["commentaire"]) || array_key_exists("commentaire", $context) ? $context["commentaire"] : (function () { throw new RuntimeError('Variable "commentaire" does not exist.', 12, $this->source); })()), "socialMedia", [], "any", false, false, false, 12), "idEB", [], "any", false, false, false, 12)]), "html", null, true);
        yield "\" class=\"btn btn-secondary\">
                <i class=\"bi bi-arrow-left\"></i> Retour au post
            </a>
        </div>
    </div>
";
...
{% block body %}
    <div class=\"container my-4\">
        ...
        {{ include('commentaire/_form.html.twig', {'button_label': 'Mettre à jour'}) }}

        <div class=\"mt-3\">
            <a href=\"{{ path('app_social_media_show', {'idEB': commentaire.socialMedia.idEB}) }}\" class=\"btn btn-secondary\">
                <i class=\"bi bi-arrow-left\"></i> Retour au post
            </a>
        </div>
    </div>
