...
/* dashVoyageurs/dashboardVoyageurs.html.twig */
class __TwigTemplate_f39587b003285237b3f59b05494233e1 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "dashVoyageurs/dashboardVoyageurs.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "dashVoyageurs/dashboardVoyageurs.html.twig"));
...
<head>
  ...
  <style>
    body {
      ...
      background-image: linear-gradient(135deg, #e6eefb 0%, #f5f9ff 100%);
    }

    .header-wrapper {
      background-color: #2b3a5c;
      background-image: linear-gradient(135deg, #2b3a5c 0%, #3a5ca5 100%);
      padding-top: 1rem;
      padding-bottom: 1rem;
      position: relative;
      z-index: 1;
    ...
    .content-card::before {
      ...
      width: 100%;
      height: 100%;
      background: linear-gradient(135deg, rgba(94, 114, 228, 0.03) 0%, rgba(255, 255, 255, 0) 60%);
      pointer-events: none;
    }
...
<body>
  ...
  <header class=\"header-wrapper\">
    <div class=\"container-fluid\">
      <div class=\"nav-container\">
        ...
        yield "?action=add\" id=\"add-bonplan-button\" data-section=\"add-bonplan-section\">Ajouter un bon plan</a>
                <a class=\"nav-submenu-item\" href=\"";
        // line 497
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("bonplanVoyageurs_page");
        yield "\" id=\"view-bonplan-button\" data-section=\"view-bonplan-section\">Voir les bons plans</a>
              </div>
            </li>
            <li class=\"nav-item\">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      // Make default section active initially, unless URL has specific section
      ...
      navLinks.forEach(link => {
        // Set active based on URL for initial load
        ...
        // Add click handler for offre button to show form
        if (link.id === 'offre-button') {
      ...
      function loadForm() {
        ...
        yield "')
          ...
          .then(html => {
            ...
            // Add event listeners to the loaded form
            setupFormListeners();
          })
          .catch(error => {
      ...
      // Function to setup event listeners on the loaded form
      function setupFormListeners() {
        const cancelButton = document.getElementById('cancel-offre');
        if (cancelButton) {
          cancelButton.addEventListener('click', function() {
            // Show default content when cancel is clicked
            contentSections.forEach(section => section.classList.remove('active'));
            defaultSection.classList.add('active');
        ...
        if (offreForm) {
          offreForm.addEventListener('submit', function(e) {
            ...
            // You would normally submit the form to the server here
            // For demo purposes, we'll just reset the form and go back to default view
            offreForm.reset();
    ...
    {
        return array (  862 => 537,  839 => 8,  729 => 595,  681 => 550,  677 => 549,  673 => 548,  661 => 538,  659 => 537,  643 => 524,  633 => 519,  620 => 511,  615 => 509,  604 => 503,  595 => 497,  591 => 496,  581 => 491,  572 => 485,  568 => 484,  558 => 479,  545 => 471,  540 => 469,  529 => 463,  524 => 461,  510 => 450,  73 => 16,  63 => 9,  59 => 8,  50 => 1,);
    }
...
<body>
  ...
  <header class=\"header-wrapper\">
    <div class=\"container-fluid\">
      <div class=\"nav-container\">
        <a class=\"navbar-brand\" href=\"#\">
          <img src=\"{{asset('images/logo-airmess.png')}}\" width=\"36\" height=\"36\" alt=\"Airmess\">
          <span>Airmess</span>
        </a>
        ...
        <div class=\"collapse navbar-collapse d-lg-flex\" id=\"navbarNav\">
          <ul class=\"nav-menu\">
            <li class=\"nav-item\">
              <a class=\"nav-link\" href=\"{{ path('dashboardVoyageurs_page') }}\" id=\"dashboard-button\" data-section=\"dashboard-section\">
                <span class=\"nav-link-icon\">
                  <img src=\"{{ asset('images/dashboard-icon.png') }}\" alt=\"Dashboard\" onerror=\"this.src='{{ asset('images/dashboard-icon.svg') }}'; this.onerror='';\">
                </span>
                Dashboard
              </a>
            </li>
            <li class=\"nav-item\">
              <a class=\"nav-link\" href=\"{{ path('userVoyageurs_page') }}\" id=\"user-button\" data-section=\"user-section\">
                <span class=\"nav-link-icon\">
                  <img src=\"{{ asset('images/user-icon.png') }}\" alt=\"Users\" onerror=\"this.src='{{ asset('images/user-icon.svg') }}'; this.onerror='';\">
                </span>
                Utilisateurs
              </a>
            </li>
            <li class=\"nav-item nav-item-dropdown\">
              <a class=\"nav-link\" href=\"#\" id=\"velo-button\">
                <span class=\"nav-link-icon\">
                  <img src=\"{{ asset('images/station-icon.png') }}\" alt=\"Bike\" onerror=\"this.src='{{ asset('images/station-icon.svg') }}'; this.onerror='';\">
                </span>
                Réserver Vélo
              </a>
              <div class=\"nav-submenu\">
                <a class=\"nav-submenu-item\" href=\"{{ path('app_reservation_transport_station') }}\" id=\"reserver-button\" data-section=\"station-section\">Reserver</a>
                <a class=\"nav-submenu-item\" href=\"{{ path('app_reservation_transport_index') }}\" id=\"reservations-button\" data-section=\"reservations-section\">Mes reservations</a>
              </div>
            </li>
            <li class=\"nav-item nav-item-dropdown\">
              <a class=\"nav-link\" href=\"#\" id=\"bonplan-button\">
                <span class=\"nav-link-icon\">
                  <img src=\"{{ asset('images/bonplan-icon.png') }}\" alt=\"Good Plan\" onerror=\"this.src='{{ asset('images/bonplan-icon.svg') }}'; this.onerror='';\">
                </span>
                Bon Plan
              </a>
              <div class=\"nav-submenu\">
                <a class=\"nav-submenu-item\" href=\"{{ path('bonplanVoyageurs_page') }}?action=add\" id=\"add-bonplan-button\" data-section=\"add-bonplan-section\">Ajouter un bon plan</a>
                <a class=\"nav-submenu-item\" href=\"{{ path('bonplanVoyageurs_page') }}\" id=\"view-bonplan-button\" data-section=\"view-bonplan-section\">Voir les bons plans</a>
              </div>
            </li>
            <li class=\"nav-item\">
              <a class=\"nav-link\" href=\"#\" id=\"offre-button\" data-section=\"offre-section\">
                <span class=\"nav-link-icon\">
                  <img src=\"{{ asset('images/offre-icon.png') }}\" alt=\"Offers\" onerror=\"this.src='{{ asset('images/offre-icon.svg') }}'; this.onerror='';\">
                </span>
                Offres
              </a>
            </li>
            <li class=\"nav-item\">
              <a class=\"nav-link\" href=\"{{ path('socialVoyageurs_page') }}\" id=\"social-button\" data-section=\"social-section\">
                <span class=\"nav-link-icon\">
                  <img src=\"{{ asset('images/social-icon.png') }}\" alt=\"Social\" onerror=\"this.src='{{ asset('images/social-icon.svg') }}'; this.onerror='';\">
                </span>
                Social Media
              </a>
            </li>
...
</html>", "dashVoyageurs/dashboardVoyageurs.html.twig", "C:\\Users\\meria\\OneDrive - ESPRIT\\Bureau\\Airmess_Web\\templates\\dashVoyageurs\\dashboardVoyageurs.html.twig");
    }
}
