 ...
 */
final class Version20250410003130 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE commentaire DROP proposedDescription, DROP isApproved, CHANGE description description LONGTEXT NOT NULL, CHANGE numberlike numberlike INT NOT NULL, CHANGE numberdislike numberdislike INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE commentaire ADD proposedDescription MEDIUMTEXT DEFAULT NULL, ADD isApproved TINYINT(1) DEFAULT 0, CHANGE description description MEDIUMTEXT NOT NULL, CHANGE numberlike numberlike INT DEFAULT 0, CHANGE numberdislike numberdislike INT DEFAULT 0
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE commentaire ADD CONSTRAINT commentaire_ibfk_1 FOREIGN KEY (idEB) REFERENCES socialmedia (idEB) ON DELETE CASCADE
        SQL);
